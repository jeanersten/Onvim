...
local palette = {
  ...
  bg1     = '#1a1a1a',  -- Main background
  bg2     = '#242424',  -- Slightly lighter background
  bg3     = '#2e2e2e',  -- Selection/highlight background
  bg4     = '#383838',  -- Lighter UI elements

  -- Foreground
  fg0     = '#b8b8b8',  -- Main text
  fg1     = '#a0a0a0',  -- Dimmed text
  fg2     = '#888888',  -- Comments, line numbers
  fg3     = '#707070',  -- Very dim text

  -- Muted
  red     = '#d08770',  -- Muted red-orange
  orange  = '#d19a66',  -- Soft orange
  yellow  = '#d5c4a1',  -- Pale yellow
  green   = '#a3be8c',  -- Muted green
  cyan    = '#88c0d0',  -- Soft cyan
  blue    = '#81a1c1',  -- Muted blue
  purple  = '#b48ead',  -- Soft purple
  magenta = '#c895bf',  -- Muted magenta
...
vim.api.nvim_set_hl(0, 'StatusLine',   {fg = palette.fg0, bg = '#404040', bold = true})
vim.api.nvim_set_hl(0, 'StatusLineNC', {fg = palette.fg2, bg = '#333333'})

vim.api.nvim_set_hl(0, 'TabLine',     {fg = palette.fg1, bg = '#333333'})
vim.api.nvim_set_hl(0, 'TabLineSel',  {fg = palette.fg0, bg = '#333333', bold = true})
vim.api.nvim_set_hl(0, 'TabLineFill', {fg = palette.fg3, bg = '#333333'})
